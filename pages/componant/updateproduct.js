...
//     async function editProduct(product_id,price,available_quantity,sub_categoryid,item_name,company_name,product_image) {
//       setAddProduct(e => ({ ...e,product_id,price,available_quantity,sub_categoryid,item_name,company_name,product_image}));
//        await handleShow2()
